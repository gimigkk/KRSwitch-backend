/*
  ...
  - You are about to drop the `BarterOffer` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `BarterTransaction` table. If the table is not empty, all the data it contains will be lost.
  ...
  - You are about to drop the `UserKRS` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "BarterOffer" DROP CONSTRAINT "BarterOffer_nimOfferer_fkey";

-- DropForeignKey
ALTER TABLE "UserKRS" DROP CONSTRAINT "UserKRS_kodeMK_fkey";

-- DropForeignKey
ALTER TABLE "UserKRS" DROP CONSTRAINT "UserKRS_nim_fkey";

-- DropTable
DROP TABLE "BarterOffer";

-- DropTable
DROP TABLE "BarterTransaction";
